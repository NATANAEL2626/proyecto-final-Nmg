...
?>
 <main class="app-content">
      <div class="app-title">
        <div>
        <h1><i class="bi bi-speedometer"></i> Modificacion del Estudiante </h1>
          <p>Dios es amor</p>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            ...
            <form action="../php/Modificar.php" method="POST"  class="formulario__register">
                       
                        <h5><input type="text" placeholder="id_nombre" name ='id_nombre'></h5>
                        ...
                        <h5><button class="btn btn-success">Modificar Datos</button></h5>
                    </form>
          </div>
